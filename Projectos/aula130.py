...
vendas_agrupadas = groupby(sorted(vendas,key=produtos),key=produtos)

for produto,vendido in vendas_agrupadas:
    total_vendas = sum(vendas[2] for vendas in vendido)
    print(f'O total de produtos {produto} é o total de vendas {total_vendas}')
